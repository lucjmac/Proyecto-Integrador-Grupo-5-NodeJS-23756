...
export async function createProduct(body) {
  ...
  const productQuery = `insert into product(product_name, product_description, price, stock,discount, sku, dues, image_Front, image_Back, category_id, licence_id) values(?,?,?,?,?,?,?,?,?,?,?)`;

  const result = await conn.query(productQuery, [
    product_name,
    product_description,
    price,
    stock,
